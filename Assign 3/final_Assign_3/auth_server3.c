...
int main(int argc, char const *argv[]) {
    ...
    strcpy(storeit[0].domain,"www.site1.unicef.org");
    strcpy(storeit[0].ipofit,"111.56.44.33");
    strcpy(storeit[1].domain,"www.site2.unicef.org");
    strcpy(storeit[1].ipofit,"222.6.224.33");
    strcpy(storeit[2].domain,"www.site3.unicef.org");
    strcpy(storeit[2].ipofit,"240.100.44.33");
    strcpy(storeit[3].domain,"www.site4.unicef.org");
    strcpy(storeit[3].ipofit,"230.56.44.33");
    int count=0;
