...
int main(int argc, char const *argv[]) {
    ...
    strcpy(ns1[0].name,"google.com");
    strcpy(ns1[0].value,"dns.google.com");
    strcpy(ns1[0].type,"NS");
    strcpy(ns1[1].name,"amnesty.com");
    strcpy(ns1[1].value,"dns.amnesty.com");
    strcpy(ns1[1].type,"NS");
    
    struct arecord a1[2];
    strcpy(a1[0].name,"dns.google.com");
    strcpy(a1[0].value,"127.0.0.4");
    strcpy(a1[0].type,"A");
    strcpy(a1[1].name,"dns.amnesty.com");
    strcpy(a1[1].value,"127.0.0.5");
    strcpy(a1[1].type,"A");
