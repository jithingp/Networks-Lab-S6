...
int main(int argc, char const *argv[]) {
    ...
    servaddr.sin_addr.s_addr = inet_addr("127.0.0.7");
    ...
    strcpy(storeit[0].domain,"www.site1.redcross.org");
    strcpy(storeit[0].ipofit,"155.56.44.33");
    strcpy(storeit[1].domain,"www.site2.redcross.org");
    strcpy(storeit[1].ipofit,"165.6.224.33");
    strcpy(storeit[2].domain,"www.site3.redcross.org");
    strcpy(storeit[2].ipofit,"175.100.44.33");
    strcpy(storeit[3].domain,"www.site4.redcross.org");
    strcpy(storeit[3].ipofit,"185.56.44.33");
    int count=0;
