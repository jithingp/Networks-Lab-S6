...
int main(int argc, char const *argv[]) {
    ...
    strcpy(storeit[0].domain,"www.site1.google.com");
    strcpy(storeit[0].ipofit,"176.56.44.33");
    strcpy(storeit[1].domain,"www.site2.google.com");
    strcpy(storeit[1].ipofit,"99.6.224.33");
    strcpy(storeit[2].domain,"www.site3.google.com");
    strcpy(storeit[2].ipofit,"150.100.44.33");
    strcpy(storeit[3].domain,"www.site4.google.com");
    strcpy(storeit[3].ipofit,"200.56.44.33");
    int count=0;
