...
int main(int argc, char const *argv[]) {
    ...
    strcpy(storeit[0].domain,"www.google.com");
    strcpy(storeit[0].ipofit,"176.56.44.33");
    strcpy(storeit[1].domain,"www.netflix.com");
    strcpy(storeit[1].ipofit,"99.6.224.33");
    strcpy(storeit[2].domain,"www.amnesty.com");
    strcpy(storeit[2].ipofit,"150.100.44.33");
    strcpy(storeit[3].domain,"www.youtube.com");
